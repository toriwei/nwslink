  ...
  return (
    <div className='header flex flex-row items-center justify-between max-h-16 text-purple-500 sm:text-orange-500 sm:text-green-500 md:text-blue-500 lg:text-pink-500'>
      ...
      <div className='flex-1 text-right space-x-4'>
        <button
          className='bg-[#0036FF] hover:bg-[#001E60] text-white px-4 py-2 text-xs sm:text-sm rounded font-bold'
          onClick={openStatsModal}
        >
          STATS
        </button>
        <button
          className='bg-[#EE1B4B] hover:bg-[#CB333B] text-white px-4 py-2 text-xs sm:text-sm rounded font-bold'
